...
function News() {
  ...
  return (
    ...
    >
      {/* Decorative details */}
      <div className="absolute top-10 right-10 w-64 h-64 bg-slate-100 rounded-full blur-[100px] pointer-events-none"></div>
      <div className="absolute bottom-10 left-10 w-72 h-72 bg-slate-100 rounded-full blur-[100px] pointer-events-none"></div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {articles.map((article, index) => (
            <div
              ...
              className={`bg-white border border-slate-200/80 hover:border-blue-900/30 rounded-xl p-8 shadow-[0_4px_25px_rgba(0,0,0,0.04)] hover:shadow-[0_15px_30px_rgba(0,0,0,0.08)] flex flex-col justify-between transition-all duration-700 ease-out transform group relative overflow-hidden ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"
              }`}
            >
              {/* Glowing Top line border accent */}
              <div className="absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-blue-900 to-amber-500 group-hover:from-amber-500 group-hover:to-blue-900 transition-all duration-300"></div>

              <div>
                {/* Article Title */}
                <h3 className="text-lg sm:text-xl font-bold text-blue-900 mb-4 line-clamp-3 group-hover:text-amber-600 transition-colors duration-300 leading-snug">
                  {article.title}
                </h3>
                
                {/* Article Text Content */}
                <p className="text-sm sm:text-base text-slate-600 leading-relaxed font-light mb-8 line-clamp-5">
                  {article.text}
                </p>
              </div>
              ...
              <div>
                ...
                <a
                  href={article.link}
                  className="inline-flex items-center gap-2 text-blue-900 hover:text-amber-600 font-semibold text-sm tracking-wider transition-colors duration-300"
                >
                  Read More
                  <svg
        ...
        >
          <button className="group relative inline-flex items-center gap-2 border-2 border-blue-900 text-blue-900 hover:text-white font-bold px-8 py-3.5 rounded-lg overflow-hidden transition-colors duration-300 cursor-pointer">
            ...
            <span className="absolute inset-0 bg-blue-900 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out z-0"></span>
          </button>
        </div>
      </div>
    </section>
